...
import { BookOpen, Loader2, AlertCircle, GraduationCap, ChevronRight } from 'lucide-react';
import { motion } from 'framer-motion';

export const StudentCurriculaList = () => {
  ...
  return (
    <div>
      ...
      <p className="text-[#5C5C5C] mb-6">Образовательные программы университета</p>
          ...
          <tbody>
            {filtered.map((c, i) => (
              <motion.tr
                ...
                onClick={() => navigate(`/curricula/${c.id_isu}`)}
              ...
              >
                ...
                <td className="px-6 py-4">
                  <ChevronRight size={16} className="text-gray-300 group-hover:text-[#1846C7] transition-colors" />
                </td>
              </motion.tr>
            ))}
          </tbody>
